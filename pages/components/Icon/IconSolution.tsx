...
export const IconSolution = memo<JSX.IntrinsicElements['svg']>(function IconSolution({ className }) {
    return (
        <svg className={cn('inline', className)} width="0.75em" height="0.75em" viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg">
            <path
