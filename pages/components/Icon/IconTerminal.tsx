...
export const IconTerminal = memo<JSX.IntrinsicElements['svg']>(function IconTerminal({ className }) {
    return (
        <svg className={className} width="1em" height="1em" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
