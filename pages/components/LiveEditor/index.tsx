...
function getProxyPath(proxy: string) {
    return import.meta.env.DEV ? `http://${location.host}/pages/components/LiveEditor/source/proxy/${proxy}-dev-proxy` : `http://${location.host}/reactuse/live-editor-assets/${proxy}.js`;
}
